...
export default function Register() {
  ...
  const strengthColor = ['', '#ef4444', '#f59e0b', '#f59e0b', '#22c55e', '#22c55e'][strengthScore];
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.sub}>Start protecting your device today</p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
            ...
            {form.password && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '4px' }}>
                <div style={{ flex: 1, height: '3px', background: 'var(--border)', borderRadius: '2px', overflow: 'hidden' }}>
                  <div style={{ width: `${(strengthScore / 5) * 100}%`, height: '100%', background: strengthColor, transition: 'all 0.3s', borderRadius: '2px' }} />
                </div>
                <span style={{ fontSize: '11px', color: strengthColor, minWidth: '60px', textAlign: 'right' }}>{strengthLabel}</span>
              </div>
            )}
          </label>
          ...
          <label style={styles.label}>
            ...
            <input
              ...
              style={{
                ...styles.input,
                borderColor: form.confirm && form.confirm !== form.password ? 'var(--red)' : 'var(--border)',
              }}
              autoComplete="new-password"
            />
          </label>
...
const styles = {
  ...
  logoText: { fontSize: '18px', fontWeight: 700, letterSpacing: '-0.02em' },
  heading: { fontSize: '24px', fontWeight: 700, letterSpacing: '-0.02em', marginBottom: '6px' },
  sub: { color: 'var(--text-muted)', marginBottom: '28px', fontSize: '14px' },
  error: {
  ...
  footer: { marginTop: '24px', textAlign: 'center', color: 'var(--text-muted)', fontSize: '13px' },
